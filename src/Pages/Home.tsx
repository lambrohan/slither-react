...
export const Home: React.FC<HomeProps> = ({}) => {
	...
	return (
		<main id="home-page" className="relative flex flex-col items-center py-16">
			...
			<Modal transparent={false} visible={modal} dismiss={() => setModal(false)}>
				<Switch test={TempOptions}>
					<div value={"Dashboard"}><Dashboard/></div>
					<div value={"Congratulation"}><Congratulation/></div>
					<div value={"EnterGame"}><EnterGame/></div>
					<div value={"GameOver"}><GameOver/></div>
					<div value={"Privacy Policy"}><PrivacyPolicy/></div>

				</Switch>
			</Modal>
				<div className="absolute right-[20px] top-[50px]">
					<Select
						options={[ "Dashboard", "Congratulation", "EnterGame", "GameOver", "Privacy Policy"]}
						label="TEMP"
